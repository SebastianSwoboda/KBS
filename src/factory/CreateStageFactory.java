...
public class CreateStageFactory {
    ...
    public void createLoginStage(Stage stage) throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("scenes/kbs_ui_login.fxml"));
    ...
    public MovieController createMovieStage(Stage stage)throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("scenes/kbs_ui_movie.fxml"));
        Parent root = loader.load();
    ...
    public MovieDetailController createMovieDetailsStage(Stage stage)throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("scenes/kbs_ui_moviedetails.fxml"));
        Parent root = loader.load();
    ...
    public void createRegisterStage(Stage stage)throws IOException{
        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("scenes/kbs_ui_register.fxml"));
        Parent root = loader.load();
